...
tag_cffile                 =  lt  t:str_cffile                   attr:attr_cffile+              ws*    wack?  gt     { return new cf.tag(t,  attr);  }
...
tag_cfinvoke               =  lt  t:str_cfinvoke                 attr:attr_cfinvoke             ws*    wack?  gt     { return new cf.tag(t,  attr);  }
...
attr_bind                         =  ws+  n:str_bind                         eql  v:value_any_maybe_empty                   {                     return             {                          name:          'bind',                         value:      v                         };              }
...
attr_cfc                          =  ws+  n:str_cfc                          eql  v:value_any_maybe_empty                   {                     return             {                          name:          n,                              value:      v                         };              }
...
attr_datasource                   =  ws+  n:str_datasource                   eql  v:value_any_maybe_empty                   {                     return             {                          name:          'datasource',                   value:      v                         };              }
...
attr_id                           =  ws+  n:str_id                           eql  v:value_any_maybe_empty                   {                     return             {                          name:          n,                              value:      v                         };              }
...
attr_name                         =  ws+  n:str_name                         eql  v:value_any_maybe_empty                   {                     return             {                          name:          n,                              value:      v                         };              }
attr_name_conflict                =  ws+  n:str_name_conflict                eql  v:value_name_conflict                     {                     return             {                          name:          n,                              value:      v                         };              }
attr_name_zip                     =  ws+  n:str_name                         eql  v:value_any_non_whitespace                {                     return             {                          name:          n,                              value:      v                         };              }
...
attr_procedure                    =  ws+  n:str_procedure                    eql  v:value_any_maybe_empty                   {                     return             {                          name:          n,                              value:      plib.stringify(v)         };              }
...
attr_table_name                   =  ws+  n:str_table_name                   eql  v:value_any_maybe_empty                   {                     return             {                          name:          'table_name',                   value:      v                         };              }
...
attr_value                        =  ws+  n:str_value                        eql  v:value_any_maybe_empty                   {                     return             {                          name:          n,                              value:      v                         };              }             
...
attr_cffile                     =  attr_action_file           /  attr_add_newline           /  attr_attributes            /  attr_charset          /  attr_file_path                  /  attr_fix_newline      /  attr_mode                    /  attr_output_file
...
attr_cfinvoke                   =  attr_component             /  attr_method_invoke /  attr_return_variable
...
attr_cfzip                      =  attr_action_zip            /  attr_charset               /  attr_destination           /  attr_entry_path       /  attr_file_path                  /  attr_filter           /  attr_name_zip                /  attr_overwrite             /  attr_prefix_path     /  attr_recurse              /  attr_show_directory               /  attr_source_path         /  attr_store_path           /  attr_variable
...
value_action_file                       =                quote_char                      v:( str_append / str_copy / str_delete / str_move / str_read_binary / str_read / str_rename / str_upload_all / str_upload / str_write )                  quote_char           {       return            v;  }
...
value_cfcookie_expires                  =                quote_char                      v:str_never        quote_char           {                return             human_date('in 30 years');          }
                                        ...
                                        /                v:value_integer                 {                  return               human_date('in ' + v + ' days');               }
...
date              = now_func { return new Date(); }
                  / v:(integer integer integer integer '-' integer integer? '-' integer integer? ) { return new Date(plib.stringify(v) + ' 00:00:00'); }
date_time         = d:date space t:time { return new Date(d.toISOString().split('T')[0] + 'T' + t.toISOString().split('T')[1]); }
...
time 
	...
	min:( [0-5] integer ) ':' 
	sec:( [0-5] integer )
	mill:( period integer integer integer integer )? { var d = new Date(); return new Date(Date.UTC(d.getFullYear(), d.getMonth(), d.getDate(), plib.stringify(hr, 'int'), plib.stringify(min, 'int'), plib.stringify(sec, 'int'), plib.stringify(mill||[0], 'int'))); }
