...
//				} else {
		...
		case 'ftp':
			...
			if ( util.isNullOrUndefined(me.attributes.passive) ) {
				me.attributes.passive = false;	
			} 
			if ( util.isNullOrUndefined(me.attributes.port) ) {
				me.attributes.port = 21;	
			} 
			if ( util.isNullOrUndefined(me.attributes.retry_count) ) {
				me.attributes.retry_count = 1;	
			} 
			if ( util.isNullOrUndefined(me.attributes.stop_on_error) ) {
				me.attributes.stop_on_error = true;	
			} 
			if ( util.isNullOrUndefined(me.attributes.timeout) ) {
		...
		case 'ldap':
			...
			if ( me.attributes.secure === 'CFSSL_BASIC' && util.isNullOrUndefined(me.attributes.username) ) {
				throw new Error('Missing required username attribute.');
			}
			if ( me.attributes.secure === 'CFSSL_BASIC' && util.isNullOrUndefined(me.attributes.password) ) {
				throw new Error('Missing required password attribute.');
			}
			if ( util.isNullOrUndefined(me.attributes.delimiter) ) {
				me.attributes.delimiter = ';';
			}
			if ( util.isNullOrUndefined(me.attributes.port) ) {
				me.attributes.port = 389;
			}
			if ( util.isNullOrUndefined(me.attributes.rebind) ) {
				me.attributes.rebind = false;
			}
			if ( util.isNullOrUndefined(me.attributes.filter) ) {
				me.attributes.filter = 'objectclass = *';
			}
			if ( util.isNullOrUndefined(me.attributes.modify_type) ) {
				me.attributes.modify_type = 'replace';
			}
			if ( util.isNullOrUndefined(me.attributes.scope) ) {
				me.attributes.scope = 'one_level';
			}
			if ( util.isNullOrUndefined(me.attributes.separator) ) {
				me.attributes.separator = ',';
			}
			if ( util.isNullOrUndefined(me.attributes.sort_control) ) {
				me.attributes.sort_control = 'asc';
			}
			if ( util.isNullOrUndefined(me.attributes.start_row) ) {
				me.attributes.start_row = 1;
			}
			if ( util.isNullOrUndefined(me.attributes.timeout) ) {
				me.attributes.timeout = 60000;
			}
			if ( util.isNullOrUndefined(me.attributes.username) ) {
				me.attributes.username = 'anonymous';
			}
			break; // ldap
		case 'log':
		...
		case 'mail':
			...
			if ( util.isNullOrUndefined(me.attributes.debug) ) {
				me.attributes.debug = false;	
			} 
			if ( util.isNullOrUndefined(me.attributes.group) ) {
				me.attributes.group = 'CurrentRow';	
			} 
			if ( util.isNullOrUndefined(me.attributes.group_case_sensitive) ) {
				me.attributes.group_case_sensitive = false;	
			} 
			if ( util.isNullOrUndefined(me.attributes.mailer_id) ) {
				me.attributes.mailer_id = 'ColdFusion Application Server';	
			} 
			if ( util.isNullOrUndefined(me.attributes.port) ) {
				me.attributes.port = 25;	
			} 
			if ( util.isNullOrUndefined(me.attributes.priority) ) {
				me.attributes.priority = 'normal';	
			} 
			if ( util.isNullOrUndefined(me.attributes.remove) ) {
			...
			if ( util.isNullOrUndefined(me.attributes.wrap_text) ) {
				me.attributes.wrap_text = 80;
			} 
			break; // mail
		case 'mailparam':
			if ( util.isNullOrUndefined(me.attributes.disposition) ) {
		...
		case 'pop':
			...
			if ( util.isNullOrUndefined(me.attributes.action) ) {
				me.attributes.action = 'get_header_only';
			}
			...
			if ( util.isNullOrUndefined(me.attributes.generate_unique_filenames) ) {
				me.attributes.generate_unique_filenames = false;
			}

			if ( util.isNullOrUndefined(me.attributes.port) ) {
				me.attributes.port = 110;
			}
...
//			console.dir(me.attributes)
			...
			if ( util.isNullOrUndefined(me.attributes.overwrite) ) {
				me.attributes.overwrite = false;
			}
			if ( util.isNullOrUndefined(me.attributes.recurse) ) {
				me.attributes.recurse = false;	
			}
			if ( util.isNullOrUndefined(me.attributes.show_directory) ) {
				me.attributes.show_directory = false;	
			}
			if ( util.isNullOrUndefined(me.attributes.store_path) ) {
