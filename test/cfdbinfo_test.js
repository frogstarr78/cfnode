...
var r;
is.throws(function () {
	r = test.cfparser.parse('<cfdbinfo>');
}, Error, "Missing required attributes");

is.throws(function () {
	r = test.cfparser.parse('<cfdbinfo type="dbnames">');
}, Error, "Missing required name attribute");

is.throws(function () {
	r = test.cfparser.parse('<cfdbinfo name="cfdbinfo_test">');
}, Error, "Missing required type attribute");

is.throws(function () {
	r = test.cfparser.parse('<cfdbinfo type="columns" name="cfdbinfo_test">');
