...
describe('Parsing the cfcase tag', function () {
    it('should eror without any defined attributes', function () {
        (function () { test.cfparser.parse('<cfcase>'); }).should.throw(/Expected " ", "\\n", or "\\t" but ">" found./);
    });

    it('should eror without required value attribute but with other attributes', function () {
        (function () { test.cfparser.parse('<cfcase delimiter=",">'); }).should.throw('Missing required "value" attribute.');
    });

    it('should eror without valid value attribute', function () {
        (function () { test.cfparser.parse('<cfcase value="">'); }).should.throw('Missing required "value" attribute.');
    });

    it('should work as expected.should.eql(defining default values', function () {
    ...
    it('should work as expected.should.eql(ovewriting default values', function () {
