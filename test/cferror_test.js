...
describe('Parsing the cferror tag', function () {
  it("should thow an error without any required attributes", function () {
    (function () { test.cfparser.parse('<cferror>'); }).should.throw('Expected " ", "\\n", or "\\t" but ">" found.');
  });
  ...
  it("should thow an error without required template attribute", function () {
    (function () { test.cfparser.parse('<cferror type="request">'); }).should.throw('Missing required "template" attribute.');
  });

  it("should thow an error without required type attribute", function () {
    (function () { test.cfparser.parse('<cferror template="/path/to/error.cfm">'); }).should.throw('Missing required "type" attribute.');
  });
