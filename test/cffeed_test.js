...
describe('Parser parsing the cffeed tag', function () {
    describe('with the create action', function () {
        ...
        it('should throw an error when missing a required output_file attribute', function () {
    ...
    describe('with the read action', function () {
        ...
        it('should throw an error when missing a required attribute other than the source attribute', function () {
