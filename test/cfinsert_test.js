...
var r;
is.throws(function () {
	r = test.cfparser.parse('<cfinsert>');
...
is.throws(function () {
	r = test.cfparser.parse('<cfinsert datasource="cfinsert_dsn">');
}, Error, "Missing required tablename attribute");

is.throws(function () {
	r = test.cfparser.parse('<cfinsert datasource="">');
}, Error, "Empty datasource attribute");

is.throws(function () {
	r = test.cfparser.parse('<cfinsert tableName="cfinsert_table">');
