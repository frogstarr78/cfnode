...
r = cf.parse('<cfloop index="count" from="1" to="3"></cfloop>');
...
r = cf.parse('<cfloop index="count" from="1" to="4" step="2" charset="utf8">' +
...
r = cf.parse('<CFLOOP INDEX="count" FROM="1" TO="4" STEP="3" CHARSET="utf8">' +
"We'll only ever get here #count#" +
"\n</CFLOOP>");
is.equal(r instanceof Object, true);
is.equal(r.tag, 'loop');
