...
// Empty tags
tag_cfabort       = lt t:str_cfabort          attr:attr_cfabort*            ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfajaximport  = lt t:str_cfajaximport     attr:attr_cfajaximport*          ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfajaxproxy   = lt t:str_cfajaxproxy      attr:attr_cfajaxproxy+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfassociate   = lt t:str_cfassociate      attr:attr_cfassociate+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfapplication = lt t:str_cfapplication    attr:attr_cfapplication+      ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfbreak       = lt t:str_cfbreak                                        ws* wack? gt { return new cftag(t, []); }
tag_cfcase        = lt t:str_cfcase           attr:attr_cfcase+             ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfdbinfo      = lt t:str_cfdbinfo         attr:attr_cfdbinfo+           ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfdefaultcase = lt t:str_cfdefaultcase                                  ws* wack? gt { return new cftag(t, []); }
tag_cfdirectory   = lt t:str_cfdirectory      attr:attr_cfdirectory+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfdump        = lt t:str_cfdump           attr:attr_cfdump+             ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cferror       = lt t:str_cferror          attr:attr_cferror+            ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfexit        = lt t:str_cfexit           attr:attr_cfexit*             ws* wack? gt { return new cftag(t, attr); }
tag_cfflush       = lt t:str_cfflush          attr:attr_interval*           ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cffile        = lt t:str_cffile           attr:attr_cffile_append+      ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_copy+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_delete+      ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_move+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_read+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_read_binary+ ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_rename+      ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_upload_all+  ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_upload+      ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
	                 / lt t:str_cffile           attr:attr_cffile_write+       ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfheader         = lt t:str_cfheader         attr:attr_cfheader*           ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfhtmlhead       = lt t:str_cfhtmlhead       attr:attr_cfhtmlhead          ws* wack? gt { return new cftag(t, [attr]); }
tag_cfhttpparam      = lt t:str_cfhttpparam      attr:attr_cfhttpparam+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
...
tag_cfinsert         = lt t:str_cfinsert         attr:attr_cfinsert+           ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
...
tag_cfparam          = lt t:str_cfparam          attr:attr_cfparam+            ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfprocparam      = lt t:str_cfprocparam      attr:attr_cfprocparam+        ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfprocresult     = lt t:str_cfprocresult     attr:attr_cfprocresult+       ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfproperty       = lt t:str_cfproperty       attr:attr_cfproperty+         ws* wack? gt {
...
tag_cfqueryparam     = lt t:str_cfqueryparam     attr:attr_cfqueryparam+       ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
//tag_cfqueryparam = lt t:str_cfqueryparam attr:( attr_cfqueryparam_optional* attr_cfqueryparam_required attr_cfqueryparam_optional* ) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
//tag_cfrethrow    = lt t:str_cfrethrow                                                                                                ws* wack? gt { return new cftag(t, []); }
tag_cfrethrow        = lt t:str_cfrethrow                                      ws* wack? gt { return new cftag(t, []); }
//tag_cfschedule = lt t:str_cfschedule attr:( attr_cfschedule_optional+ attr_action_schedule      attr_cfschedule_optional+ attr_task            attr_cfschedule_optional* / attr_cfschedule_optional+ attr_task                 attr_cfschedule_optional+ attr_action_schedule attr_cfschedule_optional* / attr_cfschedule_optional* attr_cfschedule_required+ attr_cfschedule_optional* ) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfschedule       = lt t:str_cfschedule       attr:attr_cfschedule+         ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
//tag_cfsetting = lt t:str_cfsetting attr:attr_cfsetting_optional* ws* wack? gt { return new cftag(t, attr); }
tag_cfsetting        = lt t:str_cfsetting        attr:attr_cfsetting*          ws* wack? gt { return new cftag(t,  attr); }
tag_cfstoredproc     = lt t:str_cfstoredproc     attr:attr_cfstoredproc+       ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfthrow          = lt t:str_cfthrow                                        ws* wack? gt { return new cftag(t, []); }
tag_cfupdate         = lt t:str_cfupdate         attr:attr_cfupdate+           ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfxml            = lt t:str_cfxml            attr:attr_cfxml+              ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfzip            = lt t:str_cfzip            attr:attr_cfzip+              ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfzipparam       = lt t:str_cfzipparam       attr:attr_cfzipparam*         ws* wack? gt { return new cftag(t, plib.flatten(attr)); }

// Tags requiring content
...
tag_cfcache      = lt t:str_cfcache     attr:attr_cfcache*     ws*       gt content:(!tag_cfcache_close anychar)*     tag_cfcache_close     { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
tag_cfcatch      = lt t:str_cfcatch attr:attr_cfcatch* ws* gt content:(!tag_cfcatch_close anychar)* tag_cfcatch_close { return new cftag(t, attr, plib.stringify(content)); }
tag_cfcomponent  = lt t:str_cfcomponent attr:attr_cfcomponent* ws* gt content:(!tag_cfcomponent_close anychar)* tag_cfcomponent_close { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
...
tag_cfcookie     = lt t:str_cfcookie  attr:attr_cfcookie+ ws* wack? gt { return new cftag(t, plib.flatten(attr)); }

tag_cfdbinfo      = lt t:str_cfdbinfo attr:( attr_cfdbinfo_optional* attr_cfdbinfo_required_name attr_cfdbinfo_optional* attr_cfdbinfo_required_type attr_cfdbinfo_optional* / attr_cfdbinfo_optional* attr_cfdbinfo_required_type attr_cfdbinfo_optional* attr_cfdbinfo_required_name attr_cfdbinfo_optional*) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfdefaultcase = lt t:str_cfdefaultcase ws* wack? gt { return new cftag(t, []); }
tag_cfdirectory   = lt t:str_cfdirectory attr:( attr_cfdirectory_optional* attr_cfdirectory_required attr_cfdirectory_optional* ) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfdump        = lt t:str_cfdump      attr:( attr_cfdump_optional* attr_cfdump_required attr_cfdump_optional* )                ws* wack? gt { return new cftag(t, plib.flatten(attr)); }


tag_cfelse        = lt t:str_cfelse ws* wack? gt content:(!( tag_cfif_close ) anychar)* tag_cfif_close { return new cftag(t, [], plib.stringify(content)); }
tag_cfelse        = lt t:str_cfelse                             ws* wack? gt content:(!tag_cfif_close anychar)*        tag_cfif_close        { return new cftag(t, [], plib.stringify(content)); }
tag_cffinally     = lt t:str_cffinally                          ws* gt content:(!tag_cffinally_close   anychar)* tag_cffinally_close   { return new cftag(t, [],                 plib.stringify(content)); }
tag_cfexecute     = lt t:str_cfexecute   attr:attr_cfexecute+   ws* gt content:(!tag_cfexecute_close   anychar)* tag_cfexecute_close   { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
tag_cffunction    = lt t:str_cffunction  attr:attr_cffunction+  ws* gt content:(!tag_cffunction_close anychar)*  tag_cffunction_close  { return new cftag(t,  plib.flatten(attr), plib.stringify(content)); }
tag_cfhttp        = lt t:str_cfhttp      attr:attr_cfhttp+      ws* gt content:(!tag_cfhttp_close      anychar)* tag_cfhttp_close      { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
tag_cfinterface   = lt t:str_cfinterface attr:attr_cfinterface* ws* gt content:(!tag_cfinterface_close anychar)* tag_cfinterface_close { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
tag_cflock        = lt t:str_cflock      attr:attr_cflock+      ws* gt content:(!tag_cflock_close      anychar)* tag_cflock_close      { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
tag_cflogin       = lt t:str_cflogin     attr:attr_cflogin*     ws* gt content:(!tag_cflogin_close anychar)* tag_cflogin_close { return new cftag(t, attr, plib.stringify(content)); }
...
tag_cffeed
	= tag_cffeed_create_basic
	/ tag_cffeed_create_query
	/ tag_cffeed_read

tag_cffeed_create_basic
	= lt t:str_cffeed attr:(
		( attr_cffeed_create_basic_optional* attr_cffeed_create_basic_required+ attr_cffeed_create_basic_optional* )*
		/ attr_cffeed_create_basic_optional* attr_cffeed_create_basic_required+
		/ attr_cffeed_create_basic_required+
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
tag_cffeed_create_query
	= lt t:str_cffeed attr:(
		( attr_cffeed_create_query_optional* attr_cffeed_create_query_required+ attr_cffeed_create_query_optional* )*
		/ attr_cffeed_create_query_optional* attr_cffeed_create_query_required+
		/ attr_cffeed_create_query_required+
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
tag_cffeed_read
	= lt t:str_cffeed attr:(
		( attr_cffeed_read_optional* attr_cffeed_read_required+ attr_cffeed_read_optional* )*
		/ attr_cffeed_read_optional* attr_cffeed_read_required+
		/ attr_cffeed_read_required+
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_append
	= lt t:str_cffile attr:(
		  attr_cffile_append_optional* attr_file_action attr_cffile_append_optional* attr_file_path          attr_cffile_append_optional* attr_output_file        attr_cffile_append_optional*
		/ attr_cffile_append_optional* attr_file_action attr_cffile_append_optional* attr_output_file        attr_cffile_append_optional* attr_file_path          attr_cffile_append_optional*
		/ attr_cffile_append_optional* attr_file_path          attr_cffile_append_optional* attr_file_action attr_cffile_append_optional* attr_output_file        attr_cffile_append_optional*
		/ attr_cffile_append_optional* attr_file_path          attr_cffile_append_optional* attr_output_file        attr_cffile_append_optional* attr_file_action attr_cffile_append_optional*
		/ attr_cffile_append_optional* attr_output_file        attr_cffile_append_optional* attr_file_action attr_cffile_append_optional* attr_file_path          attr_cffile_append_optional*
		/ attr_cffile_append_optional* attr_output_file        attr_cffile_append_optional* attr_file_path          attr_cffile_append_optional* attr_file_action attr_cffile_append_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_copy
	= lt t:str_cffile attr:(
		  attr_cffile_copy_optional* attr_file_action attr_cffile_copy_optional* attr_file_source      attr_cffile_copy_optional* attr_destination      attr_cffile_copy_optional*
		/ attr_cffile_copy_optional* attr_file_action attr_cffile_copy_optional* attr_destination      attr_cffile_copy_optional* attr_file_source      attr_cffile_copy_optional*
		/ attr_cffile_copy_optional* attr_file_source      attr_cffile_copy_optional* attr_file_action attr_cffile_copy_optional* attr_destination      attr_cffile_copy_optional*
		/ attr_cffile_copy_optional* attr_file_source      attr_cffile_copy_optional* attr_destination      attr_cffile_copy_optional* attr_file_action attr_cffile_copy_optional*
		/ attr_cffile_copy_optional* attr_destination      attr_cffile_copy_optional* attr_file_action attr_cffile_copy_optional* attr_file_source      attr_cffile_copy_optional*
		/ attr_cffile_copy_optional* attr_destination      attr_cffile_copy_optional* attr_file_source      attr_cffile_copy_optional* attr_file_action attr_cffile_copy_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_move
	= lt t:str_cffile attr:(
		  attr_cffile_move_optional* attr_file_action attr_cffile_move_optional* attr_file_source attr_cffile_move_optional* attr_destination attr_cffile_move_optional*
		/ attr_cffile_move_optional* attr_file_action attr_cffile_move_optional* attr_destination attr_cffile_move_optional* attr_file_source attr_cffile_move_optional*
		/ attr_cffile_move_optional* attr_file_source attr_cffile_move_optional* attr_file_action attr_cffile_move_optional* attr_destination attr_cffile_move_optional*
		/ attr_cffile_move_optional* attr_file_source attr_cffile_move_optional* attr_destination attr_cffile_move_optional* attr_file_action attr_cffile_move_optional*
		/ attr_cffile_move_optional* attr_destination attr_cffile_move_optional* attr_file_action attr_cffile_move_optional* attr_file_source attr_cffile_move_optional*
		/ attr_cffile_move_optional* attr_destination attr_cffile_move_optional* attr_file_source attr_cffile_move_optional* attr_file_action attr_cffile_move_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_read
	= lt t:str_cffile attr:(
		attr_cffile_read_optional+ attr_cffile_read_required+
		/ attr_cffile_read_required+ attr_cffile_read_optional+ attr_cffile_read_required+
		/ attr_cffile_read_required+ attr_cffile_read_optional+
		/ attr_cffile_read_required+
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}

tag_cffile_read_binary = lt t:str_cffile attr:attr_cffile_read_binary_required+ ws* wack? gt { return new cftag(t, plib.flatten(attr)); }

tag_cffile_rename
	= lt t:str_cffile attr:(
		  attr_cffile_rename_optional* attr_file_action attr_cffile_rename_optional* attr_file_source attr_cffile_rename_optional* attr_destination attr_cffile_rename_optional*
		/ attr_cffile_rename_optional* attr_file_action attr_cffile_rename_optional* attr_destination attr_cffile_rename_optional* attr_file_source attr_cffile_rename_optional*
		/ attr_cffile_rename_optional* attr_file_source attr_cffile_rename_optional* attr_file_action attr_cffile_rename_optional* attr_destination attr_cffile_rename_optional*
		/ attr_cffile_rename_optional* attr_file_source attr_cffile_rename_optional* attr_destination attr_cffile_rename_optional* attr_file_action attr_cffile_rename_optional*
		/ attr_cffile_rename_optional* attr_destination attr_cffile_rename_optional* attr_file_action attr_cffile_rename_optional* attr_file_source attr_cffile_rename_optional*
		/ attr_cffile_rename_optional* attr_destination attr_cffile_rename_optional* attr_file_source attr_cffile_rename_optional* attr_file_action attr_cffile_rename_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_upload
	= lt t:str_cffile attr:(
		  attr_cffile_upload_optional* attr_file_action attr_cffile_upload_optional* attr_file_field  attr_cffile_upload_optional* attr_destination attr_cffile_upload_optional*
		/ attr_cffile_upload_optional* attr_file_action attr_cffile_upload_optional* attr_destination attr_cffile_upload_optional* attr_file_field  attr_cffile_upload_optional*
		/ attr_cffile_upload_optional* attr_file_field  attr_cffile_upload_optional* attr_file_action attr_cffile_upload_optional* attr_destination attr_cffile_upload_optional*
		/ attr_cffile_upload_optional* attr_file_field  attr_cffile_upload_optional* attr_destination attr_cffile_upload_optional* attr_file_action attr_cffile_upload_optional*
		/ attr_cffile_upload_optional* attr_destination attr_cffile_upload_optional* attr_file_action attr_cffile_upload_optional* attr_file_field  attr_cffile_upload_optional*
		/ attr_cffile_upload_optional* attr_destination attr_cffile_upload_optional* attr_file_field  attr_cffile_upload_optional* attr_file_action attr_cffile_upload_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_upload_all
	= lt t:str_cffile attr:(
		  attr_cffile_upload_all_optional* attr_file_action attr_cffile_upload_all_optional* attr_destination attr_cffile_upload_all_optional*
		/ attr_cffile_upload_all_optional* attr_destination attr_cffile_upload_all_optional* attr_file_action attr_cffile_upload_all_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cffile_write
	= lt t:str_cffile attr:(
		  attr_cffile_write_optional* attr_file_action attr_cffile_write_optional* attr_file_path         attr_cffile_write_optional* attr_output_file       attr_cffile_write_optional*
		/ attr_cffile_write_optional* attr_file_action attr_cffile_write_optional* attr_output_file       attr_cffile_write_optional* attr_file_path         attr_cffile_write_optional*
		/ attr_cffile_write_optional* attr_file_path         attr_cffile_write_optional* attr_file_action attr_cffile_write_optional* attr_output_file       attr_cffile_write_optional*
		/ attr_cffile_write_optional* attr_file_path         attr_cffile_write_optional* attr_output_file       attr_cffile_write_optional* attr_file_action attr_cffile_write_optional*
		/ attr_cffile_write_optional* attr_output_file       attr_cffile_write_optional* attr_file_action attr_cffile_write_optional* attr_file_path  attr_cffile_write_optional*
		/ attr_cffile_write_optional* attr_output_file       attr_cffile_write_optional* attr_file_path         attr_cffile_write_optional* attr_file_action attr_cffile_write_optional*
	) ws* wack? gt {
		return new cftag(t, plib.flatten(attr));
	}
...
tag_cfftp_conn
	= lt t:str_cfftp attr:attr_cfftp_conn+ ws* wack? gt {
		var me = new cftag(t, plib.flatten(attr));
...
tag_cfftp_file_dir
	= lt t:str_cfftp attr:attr_cfftp_file_dir+ ws* wack? gt {
		var me = new cftag(t, plib.flatten(attr));
    if ( plib.is_empty(me.attributes.action) ) { 
			throw new Error("Missing required action attribute.");		
    }
...
tag_cfheader   = lt t:str_cfheader   attr:attr_cfheader_optional* ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfhtmlhead = lt t:str_cfhtmlhead attr:attr_cfhtmlhead_required ws* wack? gt { return new cftag(t, [attr]); }

tag_cfhttp
	= lt t:str_cfhttp attr:( attr_cfhttp_optional* attr_cfhttp_required attr_cfhttp_optional* ) ws* gt
	content:(!(lt wack str_cfhttp gt) anychar)*
	lt wack str_cfhttp gt {
		return new cftag(t, plib.flatten(attr), plib.stringify(content));
	}

tag_cfhttpparam = lt t:str_cfhttpparam attr:( attr_cfhttpparam_optional* attr_cfhttpparam_required attr_cfhttpparam_optional* ) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
...
tag_cfimport  = lt t:str_cfimport attr:attr_cfimport_required ws* wack? gt { return new cftag(t, attr); }
tag_cfinclude = lt t:str_cfinclude attr:attr_cfinclude_required ws* wack? gt { return new cftag(t, [attr]); }
...
tag_cfloop_array = lt t:str_cfloop attr:attr_cfloop_array+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
...
tag_cfloop_conditional = lt t:str_cfloop attr:attr_cfloop_conditional gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
...
tag_cfloop_date_range = lt t:str_cfloop attr:attr_cfloop_date_range+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
		var me = new cftag(t, plib.flatten(attr), plib.stringify(content));
...
tag_cfloop_file = lt t:str_cfloop attr:attr_cfloop_file+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
		var me = new cftag(t, plib.flatten(attr), plib.stringify(content));
...
tag_cfloop_index = lt t:str_cfloop attr:attr_cfloop_index+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
		var me = new cftag(t, plib.flatten(attr), plib.stringify(content));
		if ( plib.is_empty(me.attributes.to) ) {
			throw new Error("Missing required to attribute.");
		} else if ( plib.is_empty(me.attributes.from) ) {
...
tag_cfloop_list = lt t:str_cfloop attr:attr_cfloop_list+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
		var me = new cftag(t, plib.flatten(attr), plib.stringify(content));
		if ( plib.is_empty(me.attributes.index) ) {
			throw new Error("Missing required index attribute.");
...
tag_cfloop_query      = lt t:str_cfloop attr:attr_cfloop_query+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
  var me = new cftag(t, plib.flatten(attr), plib.stringify(content));
...
tag_cfloop_collection = lt t:str_cfloop attr:attr_cfloop_collection+ gt content:(!tag_cfloop_close anychar)* tag_cfloop_close {
		var me = new cftag(t, plib.flatten(attr), plib.stringify(content));
...
//tag_cfmail        = lt t:str_cfmail attr:( attr_cfmail_optional* attr_cfmail_required  attr_cfmail_optional* attr_cfmail_required attr_cfmail_optional* attr_cfmail_required attr_cfmail_optional* / attr_cfmail_optional* attr_cfmail_required+ attr_cfmail_optional*) ws* gt content:(!(lt wack str_cfmail gt) anychar)* lt wack str_cfmail gt { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
tag_cfmailparam   = lt t:str_cfmailparam attr:( attr_cfmailparam_optional* attr_cfmailparam_required attr_cfmailparam_optional* ) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
//tag_cfmailpart    = lt t:str_cfmailpart attr:( attr_cfmailpart_optional* attr_cfmailpart_required attr_cfmailpart_optional* ) ws* gt content:(!(lt wack str_cfmailpart gt) anychar)* lt wack str_cfmailpart gt { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
...
tag_cfobjectcache = lt t:str_cfobjectcache attr:attr_cfobjectcache_required ws* wack? gt { return new cftag(t, attr); }
//tag_cfoutput    = lt t:str_cfoutput attr:attr_cfoutput_optional* gt content:(!(lt wack str_cfoutput gt) anychar)* lt wack str_cfoutput gt { return new cftag(t, attr, plib.stringify(content)); }
...
tag_cfparam       = lt t:str_cfparam attr:( attr_cfparam_optional* attr_cfparam_required attr_cfparam_optional*) ws* wack? gt { return new cftag(t, plib.flatten(attr)); }
tag_cfpop         = lt t:str_cfpop attr:attr_cfpop+ ws* wack? gt { return new cftag(t, plib.flatten(attr)); }

//tag_cfprocessingdirective
//	= lt t:str_cfprocessingdirective attr:attr_cfprocessingdirective_optional* gt content:(!(lt wack str_cfprocessingdirective gt) anychar)* lt wack str_cfprocessingdirective gt { return new cftag(t, attr, plib.stringify(content)); }
//	/ lt t:str_cfprocessingdirective attr:attr_cfprocessingdirective_optional* ws* wack? gt { return new cftag(t, attr); }
...
tag_cfprocessingdirective
	...
	/ lt t:str_cfprocessingdirective attr:attr_cfprocessingdirective*                                                        ws* wack? gt                    { return new cftag(t, plib.flatten(attr)); }


tag_cfquery = lt t:str_cfquery attr:attr_cfquery+ gt content:(!tag_cfquery_close anychar)* tag_cfquery_close { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
//tag_cfquery = lt t:str_cfquery attr:(attr_cfquery_optional* attr_cfquery_required attr_cfquery_optional* ) gt content:(!(lt wack str_cfquery gt) anychar)* lt wack str_cfquery gt { return new cftag(t, plib.flatten(attr), plib.stringify(content)); }
...
//tag_cfsavecontent = lt t:str_cfsavecontent attr:attr_cfsavecontent_required gt content:(!(lt wack str_cfsavecontent gt) anychar)* lt wack str_cfsavecontent gt { return new cftag(t, [attr], plib.stringify(content)); }
tag_cfsavecontent = lt t:str_cfsavecontent attr:attr_cfsavecontent  gt  content:(!tag_cfsavecontent_close  anychar)*           tag_cfsavecontent_close  { return new cftag(t,  [attr], plib.stringify(content));  }
tag_cfscript      = lt t:str_cfscript                               gt  content:(!tag_cfscript_close       anychar)*           tag_cfscript_close       { return new cftag(t,  [], plib.stringify(content));  }
//tag_cfscript      = lt t:str_cfscript                               gt content:(!(lt wack str_cfscript gt) anychar)* lt wack str_cfscript gt { return new cftag(t, [], plib.stringify(content)); }
tag_cfsilent      = lt t:str_cfsilent                               gt  content:(!tag_cfsilent_close       anychar)*           tag_cfsilent_close       { return new cftag(t,  [], plib.stringify(content));  }
...
tag_cftimer       = lt t:str_cftimer       attr:attr_cftimer*       gt  content:(!tag_cftimer_close        anychar)*           tag_cftimer_close        { return new cftag(t,  attr, plib.stringify(content));  }
...
attr_cferror_required_type     = attr_type_error
...
//@TODO: enable this to allow for plain "status" attribute
...
attr_cfdump_required = attr_cfvar_var
...
attr_cflock_optional = attr_name / attr_scope_lock / attr_throw_on_timeout / attr_type_lock
...
attr_cffeed_create_basic_optional = attr_overwrite / attr_escape_chars
attr_cffeed_create_basic_required = attr_feed_action / attr_feed_name / attr_output_file_path / attr_xml_var

attr_cffeed_create_query_optional = attr_overwrite / attr_column_map
...
attr_cffile_delete_required = attr_file_path / attr_file_action
//attr_cffile_delete_optional

//attr_cffile_move_required
attr_cffile_move_optional = attr_attributes / attr_charset / attr_mode

attr_cffile_read_required = attr_file_action / attr_file_path / attr_variable
attr_cffile_read_optional = attr_charset

attr_cffile_read_binary_required = attr_file_action / attr_file_path / attr_variable
...
//attr_cfzipparam_required
attr_cfzipparam_optional = attr_charset / attr_content / attr_entry_path / attr_filter / attr_prefix_path / attr_recurse / attr_file_source
...
attr_cfzip_unzip_required = attr_zip_action / attr_destination / attr_file_path

attr_cfzip_zip_optional = attr_zip_action / attr_filter / attr_overwrite / attr_prefix_path / attr_recurse / attr_store_path
attr_cfzip_zip_required = attr_file_path / attr_zip_source
// value definitions
...
value_sql_type = quote_char v:(
  c f __ s q l __ ( str_char / str_bigint / str_bit / str_blob / str_clob / str_date / str_decimal / str_double / str_float / str_idstamp / str_integer / str_longvarchar / str_money / str_money4 / str_numeric / str_real / str_refcursor / str_smallint / str_timestamp / str_time / str_tinyint / str_varchar ) 
